...
textfiles = {"README.md"}
unpackfiles = {'gettitlestring.dtx'}
...
tdslocations={
"doc/latex/gettitlestring/gettitlestring.pdf",
"source/latex/gettitlestring/gettitlestring.dtx",
"tex/generic/gettitlestring/gettitlestring.sty",
}
